...
public class TaskEndPointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.girfanov.ru/", "TaskEndPointService");
    public final static QName TaskEndPointPort = new QName("http://endpoint.tm.girfanov.ru/", "TaskEndPointPort");
    static {
        URL url = null;
        try {
