...
public interface UserEndPoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.girfanov.ru/UserEndPoint/mergeUserPasswordRequest", output = "http://endpoint.tm.girfanov.ru/UserEndPoint/mergeUserPasswordResponse")
    @RequestWrapper(localName = "mergeUserPassword", targetNamespace = "http://endpoint.tm.girfanov.ru/", className = "ru.girfanov.tm.endpoint.MergeUserPassword")
    @ResponseWrapper(localName = "mergeUserPasswordResponse", targetNamespace = "http://endpoint.tm.girfanov.ru/", className = "ru.girfanov.tm.endpoint.MergeUserPasswordResponse")
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.girfanov.ru/UserEndPoint/removeAllUsersRequest", output = "http://endpoint.tm.girfanov.ru/UserEndPoint/removeAllUsersResponse")
    @RequestWrapper(localName = "removeAllUsers", targetNamespace = "http://endpoint.tm.girfanov.ru/", className = "ru.girfanov.tm.endpoint.RemoveAllUsers")
    @ResponseWrapper(localName = "removeAllUsersResponse", targetNamespace = "http://endpoint.tm.girfanov.ru/", className = "ru.girfanov.tm.endpoint.RemoveAllUsersResponse")
