 ...
 * 2019-04-08T12:00:33.734+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "DataDomainEndPointService",
                  wsdlLocation = "http://localhost:8080/DataDomainEndpoint?wsdl",
                  targetNamespace = "http://endpoint.tmserver.girfanov.ru/")
public class DataDomainEndPointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tmserver.girfanov.ru/", "DataDomainEndPointService");
    public final static QName DataDomainEndPointPort = new QName("http://endpoint.tmserver.girfanov.ru/", "DataDomainEndPointPort");
    static {
        URL url = null;
        try {
