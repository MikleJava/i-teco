...
public class ProjectEndPointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tmserver.girfanov.ru/", "ProjectEndPointService");
    public final static QName ProjectEndPointPort = new QName("http://endpoint.tmserver.girfanov.ru/", "ProjectEndPointPort");
    static {
        URL url = null;
        try {
