...
public class UserEndPointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tmserver.girfanov.ru/", "UserEndPointService");
    public final static QName UserEndPointPort = new QName("http://endpoint.tmserver.girfanov.ru/", "UserEndPointPort");
    static {
        URL url = null;
        try {
